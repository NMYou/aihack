...
if($_SERVER['REQUEST_METHOD'] == "POST" and isset($_POST['submitdon'])){
    ...
    $projectname ="Urmila Bamankar Receiver";
        ...
        <div class="carousel-item active">
            <div class="carousel-container">
                ...
                <p class="animate__animated animate__fadeInUp">
                    <img src="https://images.unsplash.com/photo-1440428099904-c6d459a7e7b5?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80" alt="Cow Farm" width="300px" height="300px"><br><br>
