...
if($_SERVER['REQUEST_METHOD'] == "POST" and isset($_POST['submitdon'])){
    ...
    $projectname ="Jyoti Pathak Receiver";
  ...
  <body>
      ...
      <section id="hero" class="d-flex justify-content-center align-items-center">
        ...
        <div class="carousel-item active">
            <div class="carousel-container">
                ...
                <p class="animate__animated animate__fadeInUp">
                    <img src="https://images.unsplash.com/photo-1504805572947-34fad45aed93?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80" alt="Do Something Great" width="300px" height="300px"><br><br>
                    Have started a startup and need funds to set in motion. Please do help.
                </p>
        ...
        <div class="carousel-item">
            ...
            <div class="carousel-container">
                <h2 class="animate__animated animate__backInDown">
                    <span>Let's Help By Donating Her </span>
                </h2>
                <!-- <p class="animate__animated animate__fadeInUp">
